<template>
	<uni-popup ref="popup" type="bottom">
		...
		<view class="flex justify-center align-center">
			<view 
				class="flex-1 flex flex-column justify-center align-center py-2"
				hover-class="bg-light"
				v-for="(item,index) in providerList"
				:key="index"
				:disabled="isDisableButton(item)"
				@tap="share(item)"
				
			>
				<view 
					class="iconfont text-white flex justify-center align-center font-lg rounded-circle"
